...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>A-7, Institutional Area, near Satyawadi Raja Harish Chandra Hospital, New Delhi, Delhi 110040</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>191210024@nitdelhi.ac.in & 191210020@nitdelhi.ac.in</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>+91 - 9462570504</p><br><br><br>
	</div>&nbsp;

  <!--Feedback Start Here-->
  <!-- Get a feedback from the customers -->
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Developed Jaivardhan & Garima</p>
</footer>
